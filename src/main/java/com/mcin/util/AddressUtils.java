...
public class AddressUtils {
    // 这里调用淘宝API
    private static final String URL_STR = "http://ip.taobao.com/service/getIpInfo.php";
    /**
     *
     * @param content
    ...
    public static String getAddresses(String content,String encoding)
        ...
        String returnStr = getResult(URL_STR, sb.toString(), encoding);
        if (returnStr != null) {
            // 处理返回的省市区信息
    ...
    public static void main(String[] args) {
        ...
        try {
            json_result = AddressUtils.getAddresses(ip, "utf-8");
