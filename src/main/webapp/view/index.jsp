...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/bootstrap.min.css" />

    <!-- CSS | font-awesome -->
    <!-- Credits: http://fortawesome.github.io/Font-Awesome/icons/ -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/font-awesome.min.css" />

    <!-- CSS | Colors -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/colors/DarkBlue.css" id="colors-style" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/switcher.css" />

    <!-- CSS | animate -->
    <!-- Credits: http://daneden.github.io/animate.css/ -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/animate.min.css" />

    <!-- CSS | Normalize -->
    <!-- Credits: http://manos.malihu.gr/jquery-custom-content-scroller -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/jquery.mCustomScrollbar.css" />
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/prettyPhoto.css" />

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/view/images/favicon/favicon.ico">
...
<nav class="wjy-nav">
    <ul>
        <li>您好 ：<span>${name}</span>&nbsp;
            <c:if test="${not empty nickName }"> <span>${infoModel.nickName}</span> </c:if>
            <c:if test="${empty nickName }"> <span>${infoModel.email}</span> </c:if>
        </li>
        <%--${manage}--%>
        <li><a href="${pageContext.request.contextPath}/home/logout.json?userId=${infoModel.userId}" >控制面板</a></li>
        <li><a href="${pageContext.request.contextPath}/home/logout.json">退出登录</a></li>
    </ul>
</nav>

<footer class="wjy-footer">
    <c:if test="${not empty ip}" >
        <p>当前登录IP:<span>${ip}</span></p>
    </c:if>
</footer>
...
<!-- /.slideshow -->
<%-- userId --%>
<input type="hidden" id="userId" value="${infoModel.userId}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-3 col-xs-12 ">
                                    ...
                                    <div class="image-holder one" id="pic_prof_1" style="display:block">
                                        ...
                                        <img class="head-image up circle" src="${pageContext.request.contextPath}/view/images/img/up.png" width="150" height="150" alt="" />
                                        <img class="head-image up-left circle" src="${pageContext.request.contextPath}/view/images/img/upleft.png" width="150" height="150" alt="" />
                                        <img class="head-image left circle" src="${pageContext.request.contextPath}/view/images/img/left.png" width="150" height="150" alt="" />
                                        <img class="head-image down-left circle" src="${pageContext.request.contextPath}/view/images/img/downleft.png" width="150" height="150" alt="" />
                                        <img class="head-image down circle" src="${pageContext.request.contextPath}/view/images/img/down.png" width="150" height="150" alt="" />
                                        <img class="head-image down-right circle" src="${pageContext.request.contextPath}/view/images/img/downright.png" width="150" height="150" alt="" />
                                        <img class="head-image right circle" src="${pageContext.request.contextPath}/view/images/img/right.png" width="150" height="150" alt="" />
                                        <img class="head-image up-right circle" src="${pageContext.request.contextPath}/view/images/img/upright.png" width="150" height="150" alt="" />
                                        <img class="head-image front circle" src="${pageContext.request.contextPath}/view/images/img/front.png" width="150" height="150" alt="" />
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-12">
                                    <div id="profile_info">
                                        <h1 id="name" class="transition-02">${infoMode.userName}</h1>
                                        <h4 class="line">Java 后台开发</h4>
                                        <h6><span class="fa fa-map-marker"></span> 现居住地：${infoMode.apartment}</h6>
                                    </div>
                                    <div id="profile_desc">
                                        <h3 style="color: darkgrey">自我评价 </h3>
                                        <p> 爱学习，有着团队开发的精神，喜欢学习新技术 </p>
                                    </div>
                            ...
                            <div id="verticalTab">
                                ...
                                <div class="resp-tabs-container">
                                    <div id="profile" class="content_2">
                                        <h1 class="h-bloc">个人信息模块</h1>
                                        <div class="row top-p">
                                            <div class="col-md-6 profile-l">
                                                <div class="title_content">
                                                    <div class="text_content">基本资料</div>
                                                    <div class="clear"></div>
                                                </div>
                                                <ul class="about">
                                                    <li>
                                                        ...
                                                        <label>姓名</label>
                                                        <span class="value">${infoMode.userName}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-calendar"></i>
                                                        <label>生日</label>
                                                        <span class="value">${infoMode.birthday}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-map-marker"></i>
                                                        <label>籍贯</label>
                                                        <span class="value">${infoModel.place}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>邮箱</label>
                                                        <span class="value">${infoMode.email}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-phone"></i>
                                                        <label>手机</label>
                                                        <span class="value">${infoModel.phone}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-globe"></i>
                                                        <label>身高</label>
                                                        <span class="value">${infoModel.height} CM</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>学校</label>
                                                        <span class="value">${infoMode.school}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-globe"></i>
                                                        <label>学历</label>
                                                        <span class="value">${infoModel.education}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>专业</label>
                                                        <span class="value">${infoMode.major}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>毕业时间</label>
                                                        <span class="value">${infoMode.graduationTime}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>应聘岗位</label>
                                                        <span class="value">${infoMode.jobPosition}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                    <c:if test="${not empty infoModel.openName}">
                                                        <li>
                                                            <i class="glyphicon glyphicon-globe"></i>
                                                            <label>${infoModel.openName}</label>
                                                            <span class="value"><a href="${infoMode.openSource}" target="_blank">${infoMode.openSource}</a></span>
                                                            <div class="clear"></div>
                                                        </li>
                                                    </c:if>

                                                    <c:if test="${not empty infoModel.personalWebsite}">
                                                        <li>
                                                            <i class="glyphicon glyphicon-globe"></i>
                                                            <label>个人网站</label>
                                                            <span class="value"><a href="${infoModel.personalWebsite}" target="_blank">${infoModel.personalWebsite}</a></span>
                                                            <div class="clear"></div>
                                                        </li>
                                                    </c:if>
                                                    ...
                                                    <li>
                                                        <i class="glyphicon glyphicon-envelope"></i>
                                                        <label>薪资要求</label>
                                                        <span class="value">${wages}</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                </ul>
                                                <p style="margin-bottom:20px">工作环境要求：有良好的技术氛围</p>
                                            </div>
                                            <div class="col-md-6 profile-r">
                                                <div class="cycle-slideshow">
                                                    <img src="${pageContext.request.contextPath}/view/images/img-profile/about_1.jpg" alt="" />
                                                    <img src="${pageContext.request.contextPath}/view/images/img-profile/about_2.png" alt="" />
                                                    <img src="${pageContext.request.contextPath}/view/images/img-profile/about_3.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                      <%--  <div class="clear"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="bottom-p">
                                                    <div class="title_content">
                                                        <div class="text_content">我的开发</div>
                                                        <div class="clear"></div>
                                                    </div>
                                                    <div class="panel-group" id="accordion">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div id="collapseOne" class="panel-collapse collapse in">
                                                                <div class="panel-body">
                                                                    ...
                                                                    基于微信上开发的中国移动部分项目,网上营业厅,校园营销,移动用户各种优惠的活动
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div id="collapseTwo" class="panel-collapse collapse">
                                                                <div class="panel-body">
                                                                    <i class="fa fa-quote-left"></i>
                                                                    app项目后台管理系统,整个系统中占40%的模块完成开发,前后端直接交互的方式来完成的开发，<br>使用velocity和spring mvc 进行交互
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div id="collapseThree" class="panel-collapse collapse">
                                                                <div class="panel-body">
                                                                    <i class="fa fa-quote-left"></i>
                                                                   独立完成一整个app后台接口的开发,接口为json格式,app类似于嘀嘀打车，用户端下单,商家端接单的功能,我所独立开发的为商户端，也开发了一些用户端的模块,<br>运用到个推,支付宝支付,七牛云存储
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="resume" class="content_2">
                                        <h1 class="h-bloc">技能专长</h1>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="title_content" style="float: none;">
                                                    <div class="text_content">开发技术</div>
                                                    <div class="clear"></div>
                                                </div>
                                                ...
                                                <div class="skills">
                                                        ...
                                                        <div class="skillbar clearfix" data-percent="90%">
                                                            <div class="skillbar-title">
                                                                    <span>Jsp,Velocity,Servlet</span>
                                                            </div>
                                                            <div class="skillbar-bar"></div>
                                                        ...
                                                        <div class="skillbar clearfix" data-percent="65%">
                                                            <div class="skillbar-title">
                                                                <span>Spting,Spring MVC,Mybatis,</span>
                                                            </div>
                                                            <div class="skillbar-bar"></div>
                                            ...
                                            <div class="col-md-6 resume-left">
                                                ...
                                                <div class="title_content" style="margin-bottom:5px">
                                                    <div class="text_content"> 工作经验 </div>
                                                    <div class="clear"></div>
                                                </div>
                                                <!-- /.title_content -->
                                                ...
                                                <!-- .title_content -->
                                                <div class="title_content">
                                                    <div class="text_content">教育背景</div>
                                                    <div class="clear"></div>
                                                </div>
                                                <!-- /.title_content -->
                                            ...
                                            <div id="portfoliolist">
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    ...
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/1.jpg" rel="portfolio" title="Lorem ipsum dolor sit amet, consectetur adipiscing Vivamus sit amet ligula non lectus.consectetur adipiscingVivamus sit amet">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/1.jpg" alt="Visual Infography" />
                                                            <div class="label">
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    ...
                                                    <div class="portfolio-wrapper">
                                                        <a href="http://www.youtube.com/watch?v=c9MnSeYYtYY" rel="portfolio">
                                                            ...
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/2.jpg" alt="Visual Infography" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/3.jpg" rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/3.jpg" alt="Sonor's Design" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Web design</span>
                                                ...
                                                <div class="portfolio catMotion" data-cat="catMotion">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/4.jpg" rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/4.jpg" alt="Typography Company" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/5.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/5.jpg" alt="Weatherette" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Web Design</span>
                                                ...
                                                <div class="portfolio catMotion" data-cat="catMotion">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/6.jpg" rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/6.jpg" alt="BMF" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Motion Graphic</span>
                                                ...
                                                <div class="portfolio catGraphic" data-cat="catGraphic">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/7.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/7.jpg" alt="Techlion" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/8.jpg" rel="portfolio" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien.">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/8.jpg" alt="KittyPic" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Logo</span>
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/9.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/9.jpg" alt="Graph Plotting" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Web Design</span>
                                                ...
                                                <div class="portfolio catGraphic" data-cat="catGraphic">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/10.jpg" rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/10.jpg" alt="QR Quick Response" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Graphic Design</span>
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/11.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/11.jpg" alt="Mobi Sock" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Logo</span>
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${pageContext.request.contextPath}/view/images/portfolio/12.jpg" rel="portfolio">
                                                            <img src="${pageContext.request.contextPath}/view/images/portfolio/12.jpg" alt="Village Community Church" />
                                                            <div class="label">
                                                                <div class="label-text">
                                                                    <a class="text-title">Project Name</a>
                                                                    <span class="text-category">Logo</span>
                                                                                ...
                                                                                <div id="carousel-1" class="carousel slide" data-ride="carousel">
                                                                                    ...
                                                                                    <div class="carousel-inner">
                                                                                        ...
                                                                                        <div class="item active">
                                                                                            <img src="${pageContext.request.contextPath}/view/images/blog/blog-1.jpg" alt="" />
                                                                                        ...
                                                                                        <div class="item">
                                                                                            <img src="${pageContext.request.contextPath}/view/images/blog/blog-2.jpg" alt="" />
                                                                                            <div class="carousel-caption">
                                                                                                <h4>First Thumbnail label</h4>
                                                                                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="item">
                                                                                            <img src="${pageContext.request.contextPath}/view/images/blog/blog-3.jpg" alt="" />
                                                                                            <div class="carousel-caption">
                                                                                                <h4>First Thumbnail label</h4>
                                                                                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                                                            </div>
                                                                            ...
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content">
                                                                                        <a href="#post-1" class="read_more">Blog Post Gallery</a>
                                                                                    </div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12 post_content">
                                                                        <div class="content post_format_standart">
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content">
                                                                                        <a href="#post-2" class="read_more">Blog Aside post</a>
                                                                                    </div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        ...
                                                                        <div class="media">
                                                                            <div class="he-wrap tpl2">
                                                                                <img src="${pageContext.request.contextPath}/view/images/blog/blog-4.jpg" class="img-hover" alt="" />
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-12 post_content">
                                                                        <div class="content post_format_standart">
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content">
                                                                                        <a href="#post-3" class="read_more">Blog Post Image</a>
                                                                                    </div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12 first">
                                                                        ...
                                                                        <div class="about_author">
                                                                            ...
                                                                            <div class="prg_content">
                                                                                ...
                                                                                <div class="text">
                                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent condimentum sed elit vitae tristique. Aliquam erat volutpat. Nunc sit amet cursus libero. In fringilla egestas ornare.
                                                                                </div>
                                                            ...
                                                            <div class="col-md-12" style="width: 100%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;float: left;background: rgba(255, 255, 255, 0.8);padding-bottom: 15px;padding-top: 15px;">
                                                                ...
                                                                <article class="postPage">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        ...
                                                                        <div class="media">
                                                                            <div class="he-wrap tpl2">
                                                                                <img src="${pageContext.request.contextPath}/view/images/blog/blog-2.jpg" class="img-hover" alt="">
                                                                            </div>
...
<div id="custumize-style">
    <h2>选中样式<a href="#" class="switcher"><i class="fa fa-cogs icon-switcher"></i></a></h2>
    <div>
        <h3 class="layouts">切换头像</h3>
        <div id="show">
            <div class="clean-check">
                <input type="radio" id="r1" name="style_profile" value="style_profile_1" checked="checked" />
                <label for="r1"><span></span>头像一</label>
                <input type="radio" id="r2" name="style_profile" value="style_profile_2" />
                <label for="r2"><span></span>头像二</label>
            </div>
        </div>
        <h3 class="layouts">页面款式</h3>
        <div id="show">
        ...
        <div id="show">
            <div class="clean-check">
                ...
                <label for="s1"><span></span>色彩</label>
    ...
    <%--<div id="button-reset"><a href="#" class="button color blue boxed">重置样式</a></div>--%>
</div>
<!-- End Switcher -->
<!-- End Switcher -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jquery.min.js"></script>

<!-- Js | jquery.cycle -->
<!-- Credits: https://github.com/malsup/cycle2 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jquery.cycle2.min.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/easyResponsiveTabs.min.js"></script>

<!-- Js | jquery.cookie -->
<!-- Credits: https://github.com/carhartl/jquery-cookie -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jsSwitcher/jquery.cookie.js"></script>

<!-- Js | switcher -->
<!-- Credits: http://themeforest.net/user/FlexyCodes -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jsSwitcher/switcher.js"></script>

<!-- Js | mCustomScrollbar -->
<!-- Credits: http://manos.malihu.gr/jquery-custom-content-scroller -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jquery.mCustomScrollbar.concat.min.js"></script>

<!-- Js | gmaps -->
<!-- Credits: http://maps.google.com/maps/api/js?sensor=true-->

<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/gmaps.min.js"></script>

<!-- Js | Js -->
<!-- Credits: http://themeforest.net/user/FlexyCodes -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/main.js"></script>

<!-- jquery | rotate and portfolio -->
<!-- Credits: http://jquery.com -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jquery.mixitup.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/HeadImage.js"></script>

<!-- jquery | prettyPhoto -->
<!-- Credits: http://www.no-margin-for-errors.com/ -->
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/view/js/myJS/index.js"></script>
